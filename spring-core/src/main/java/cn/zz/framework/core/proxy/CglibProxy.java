...
import cn.zz.framework.core.container.InterceptContainer;
...
import cn.zz.framework.core.exception.MappedExecutableException;
import cn.zz.framework.core.util.*;
...
public class CglibProxy implements MethodInterceptor {
    ...
    public static void main(String[] args) {
        System.out.println(CglibProxy.class.getConstructors().toString());
    }
}
